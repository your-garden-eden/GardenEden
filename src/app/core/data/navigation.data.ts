  ...
  export const navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { label: 'Gartenteppiche', i18nId: '@@header.nav.deco.rugs', link: '/product-list/deko-licht-gartenteppiche', iconFilename: 'Teppich.png' } // Sicherstellen, dass Dateiname stimmt!
      ]
    },
     {
